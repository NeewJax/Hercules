...
if (!mime) throw '*[❗] Responde / Mencione a uma imagem*'
if (!/image\/(jpe?g|png)/.test(mime)) throw `*[❗] O tipo de arquivo ${mime} não é correto, Lembre-se que deve ser uma imagem, jpg, jpeg ou png*`
if (!text) return m.reply(`*[❗𝐈𝐍𝐅𝐎❗] Como usar esse comando?*
—◉ #phmaker (opção) <responder / etiquetar a uma imagem>

*Exemplo:*
—◉ ${usedPrefix + command} artist_in_the_dark <responder / mencionar a uma imagem>
...
m.reply('*[❗] fazendo design, por favor aguarde um momento*')
