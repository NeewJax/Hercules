...
if (new Date - user.lastclaim < 7200000) return await conn.reply(m.chat, `Você já pegou o seu presente 🎁\nVolte em *${msToTime(time - new Date())}* para reivindicar novamente`, fkontak,  m)
