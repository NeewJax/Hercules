...
if (new Date - global.db.data.users[m.sender].lastcofre < 86400000) throw `[❗𝐈𝐍𝐅𝐎❗]  VOCÊ JÁ REIVINDICOU SEU BAÚ\nVOLTE  *${msToTime(time - new Date())}*  PARA BAÚ `
