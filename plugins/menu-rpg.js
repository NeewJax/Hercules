...
┣ ඬ⃟ 💵 _${usedPrefix}roubar <quantidade> @tag
┣ ඬ⃟ 💵 _${usedPrefix}transfer <tipo> <quantidade> <@tag>_
...
handler.command = /^(menu4|menurpgs|menu rpg|menu-rpg|menurpg|menu-rpgs|memu4|meni4|rpgmenu|rpg-menu|rpg|rpgs)$/i
handler.exp = 50
handler.fail = null
