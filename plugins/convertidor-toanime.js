...
if (!/image/g.test(mime)) throw '*[❗] responda ou marque uma imagem*'
m.reply('*[❗] CONVERTENDO IMAGEM EM DESIGN DE ANIME, SEJA PACIENTE ENQUANTO ENVIO O RESULTADO*')    
...
throw '*[❗] Erro... Verifique se aimagem o rosto de uma pessoa é visível...*'
}}}}
