...
let join = `*< Adicione o bot no teu grupo />*\n\n*Oii usuario(a)*\n*Para solicitar que o bot entre no seu grupo digite #join e o link do seu grupo*\n\n*—◉ Exemplo:*\n*◉ #join* https://chat.whatsapp.com/C08Msr9F9Cs7NpQdIbJfaT`.trim() 
this.sendButton(m.chat, join, wm, imagen4, [['📮 DOAR 📮', '#doar']], m)}    
    /*
...
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp3', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}
    */
if (!chat.isBanned && chat.audios && m.text.match(/(miarda de bot|merda de bot|bot de merda|mierda de bot|mearda de bot|Miarda de Bot|Mierda de Bot|Mearda de Bot)/gi)) {    
    this.sendPresenceUpdate('typing', m.chat)   
    this.reply(m.chat, 'merda é você, seu corno!')}    

if (!chat.isBanned && chat.audios && m.text.match(/(bot lixo|bot corno|b0t corno|lixo de bot|esse bot é um lixo|b0t lixo|l1x0 de b0t|lix0 de bot|l1xo de b0t|b0t l1x0)/gi)) {    
    this.sendPresenceUpdate('typing', m.chat)   
    this.reply(m.chat, 'Não foi isso que sua mãe me disse na cama ontem a noite...')}  
