...
if (!args[0]) throw '*[❗𝐈𝐍𝐅𝐎❗] Erro, POR FAVOR TENTE NOVAMENTE*\n\n*- O LINK DEVE SER SEMELHANTE A:*\n*◉ https://drive.google.com/file/d/1dmHlx1WTbH5yZoNa_ln325q5dxLn1QHU/view*' 
try {
GDriveDl(args[0]).then(async (res) => {
conn.reply(m.chat, 'Baixando seu arquivo, aguarde um momento...\n\nO tempo de espera pode variar dependendo do peso do arquivo!', m)
if (!res) throw res
